...
public class OrderRepositoryImpl implements OrderRepository {
    ...
    public List<Param> getOrders() {
        return namedParameterJdbcTemplate.query("select orders.id, clientId, name, count from orders inner join products on orders.productid = products.id", new OrderMap());
    }
}